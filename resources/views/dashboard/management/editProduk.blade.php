...
@section('container')
    ...
    <div class=" col-lg-8">
        <form method="post" action="/updateProduk/{{ $item->id }}" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                ...
                <input type="text" name="namaItem" class="form-control @error('namaItem') is-invalid @enderror"
                    id="title" placeholder="Nama Item..." required autofocus value="{{ old('namaItem', $item->nama) }}">
                @error('namaItem')
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('category_id') is-invalid @enderror" name="category_id"
                    ...
                    @foreach ($kategori as $category)
                        @if (old('category_id', $item->kategori_id) == $category->id)
            ...
            <div class="mb-3">
                ...
                <input type="text" name="netto" class="form-control @error('netto') is-invalid @enderror"
                    id="netto" placeholder="Netto Item..." required autofocus value="{{ old('netto', $item->netto) }}">
                @error('netto')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="harga" class="form-control @error('harga') is-invalid @enderror"
                    id="harga" placeholder="Harga Item..." required autofocus value="{{ old('harga', $item->harga) }}">
                @error('harga')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                @if ($item->gambar != null)
                    <img src="{{ asset('storage/' . $item->gambar) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block"
            ...
            <div class="mb-3">
                ...
                {{-- <div class="form-text">Masukan Judul</div> --}}
                <input id="x" value="{{ old('deskripsi', $item->deskripsi) }}" type="hidden" name="deskripsi"
                    required>
